...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_imu_forward = n.subscribe("/plvio_estimator/imu_propagate", 2000, imu_forward_callback);
    ros::Subscriber sub_vio = n.subscribe("/plvio_estimator/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/plvio_estimator/key_poses", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/plvio_estimator/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/plvio_estimator/point_cloud", 2000, point_callback);
    ros::Subscriber sub_relo_relative_pose = n.subscribe("/plvio_estimator/relo_relative_pose", 2000, relo_relative_pose_callback);
